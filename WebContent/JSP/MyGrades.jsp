                    ...
                    <div class="list" style="margin-top: 0;">
                        ...
                        <table class="c-list" >
                            ...
                            <tr>
                                ...
                                <td width="10%"><%= 1 %></td>
                                <td width="10%"><%= score.getCode() %></td>
                                <td width="10%"><%= score.getLessonID() %></td>
                                <td width="20%"><%= score.getName() %></td>
                                <td width="14%"><%= score.getType() %></td>
                                <td width="6%"><%= score.getCredit() %></td>
                                <td width="6%"><%= score.getRegular() %></td>
                                <td width="6%"><%= score.getFinalExam() %></td>
                                <td width="6%"><%= score.getTotal() %></td>
                                <td width="6%"><%= score.getTotal() %></td>
                                <td width="6%"><%= score.getGP() %></td>
                            </tr>
							<%
                                    }
                            %>
